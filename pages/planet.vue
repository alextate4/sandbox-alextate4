<template>
  <div>
    ...
    <main class="bg-bgIndigo">
      ...
      >
        <span class="lowercase font-voyager-light text-veryLightGray"
          >Points of Interest</span
        >
      </div>
      <p
        class="mt-10 px-12 text-xl leading-6 font-montserrat-medium text-veryLightGray"
      >
      ...
      <img
        class="mt-10 mx-auto"
        src="~/assets/images/svg/mercury-info.svg"
        alt="Mercury Infographic"
      />
      <p class="mt-6 px-12 font-montserrat italic text-sm text-mercuryLavender">
        On this scale, Mercury would be about the size of a prairie dog, at 0.50
        m (1.64 ft) in diameter.
      </p>
      <p class="mt-12 px-12 font-montserrat-medium text-veryLightGray">
      ...
      <p class="mt-6 px-12 font-montserrat-medium text-veryLightGray">
